...
"""Train LightGBM regression models for fungal environmental variables.
...
4. Tune LightGBM hyperparameters with 5-fold cross-validation on the training set.
...
8. Calculate LightGBM gain importance and permutation importance.
...
# 1. Configuration
# =============================================================================
OTU_PATH = r"/mnt/data/home/tycloud/lijiaying/Fungi/otu/20251105_core_fungi_0.05freq.txt"
ENV_PATH = r"/mnt/data/home/tycloud/lijiaying/Fungi/env/20251214_fungi_env.txt"
CLIMATE_PATH = r"/mnt/data/home/tycloud/lijiaying/Fungi/climate/20251214_fungi_BIO1&12.txt"
OUTDIR = r"/mnt/data/home/tycloud/lijiaying/Fungi/machine_learning/lightGBM_BIO1_12"
...
for target in env_all.columns:
    ...
    # Step 4.3: Tune LightGBM hyperparameters with 5-fold CV on training data.
    ...
    effective_trees = getattr(model, "best_iteration_", None)
    ...
    # Step 4.7: Calculate gain importance and permutation importance.
    ...
    importance_df = pd.DataFrame(
        {
            ...
            "gain_importance": np.asarray(gain_importance, dtype=float),
    ...
    dump(model, os.path.join(target_dir, f"{safe_target}_LightGBMModel.joblib"))
...
# =============================================================================
with open(os.path.join(OUTDIR, "lightgbm_fungi_summary.json"), "w", encoding="utf-8") as handle:
